...
STRUCTURAL CONSTRAINT: No paragraph exceeds 4 lines. Every paragraph must open with a business outcome, market context, or organizational impact — never with "I." Sentences average 18-25 words. Use semicolons and subordinate clauses. No contractions. No exclamation marks. The letter should read like a business case, not a personal pitch. The closing paragraph must be 2 sentences maximum — one stating what you bring to the conversation commercially, one pulling the reader toward a next step. No meeting agendas, no lists of discussion topics, no "I look forward to discussing X, Y, and Z." End like a closing argument, not a calendar invite. Total length: 260-280 words.`
          : tone === "direct"
